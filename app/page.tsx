      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
        <div className="text-center space-y-8">
          ...
          <div className="flex justify-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="w-24 sm:w-32 h-24 sm:h-32 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-3xl sm:text-4xl font-bold text-primary-foreground glow">
              SD
            </div>
          </div>
          ...
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground">Shomalik Davlatov</h1>
            <p className="text-xl sm:text-2xl text-primary font-semibold">{t("home.title")}</p>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">{t("home.subtitle")}</p>
          </div>
